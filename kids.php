...
$sql = "SELECT * FROM produk WHERE kategori='Dadu'";
...
<head>
    ...
    <title>Yoshi Meat - Dadu Collection</title>
...
<body>
    ...
    <main>
        <section id="hero">
            ...
            <h2 style="font-size: 2rem; margin-top: 150px; margin-bottom: 0.1em;">DADU COLLECTION </h2>
            <p>Choose your best dadu product.</p>
