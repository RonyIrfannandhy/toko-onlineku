...
$sql = "SELECT * FROM produk WHERE kategori='Slice'";
...
<head>
    ...
    <title>Yoshi Meat - Slice Collection</title>
    ...
    <style>
        .hero-background {
            background-image: url(img/beef_slice.jpeg);
        }
    </style>
</head>
...
<body>
    ...
    <main>
        <section id="hero">
            ...
            <h2 style="font-size: 2rem; margin-top: 150px; margin-bottom: 0.1em;">SLICE COLLECTION </h2>
            <p>Choose your best slice product.</p>
